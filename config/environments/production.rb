Rails.application.configure do
  ...
  config.action_mailer.smtp_settings = {
    ...
    port:                 587,
    domain:               'gmail.com',
    user_name:            'carlo.martinucci@gmail.com',
...
Rails.application.config.middleware.use ExceptionNotification::Rack,
  :email => {
    ...
    :email_prefix => "[ERROR agnese2018] ",
    :sender_address => %{"notifier" <notifier@agnese2018.com>},
    :exception_recipients => %w{carlo.martinucci@gmail.com}
  }
